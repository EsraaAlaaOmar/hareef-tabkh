...
const AddNews = () => {
//   https://vf.alerting.services/HarefKoraApis/Talents/AddNews
const [reqdata,setReqData]=useState<any>({})
const {title,description,imgUrl} = reqdata
const AddNewsFunc =async (e:any)=>{
   e.preventDefault()
    try {
        const response = await axios.post(" https://vf.alerting.services/HarefKoraApis/Talents/AddNews", reqdata,{ headers: {
