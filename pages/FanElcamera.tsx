...
import Fanelcameradetails from '../components/reusable/Fanelcameradetails'
import {MdOutlineKeyboardArrowLeft} from'react-icons/md'
import Image from 'next/image'
import {MdSquare} from 'react-icons/md'
import FanelCameraItem from '../components/reusable/FanelCameraItem'
const FanElcamera = () => {
    return (
        < >
             <Navbar />
      <div className='fanelcamira'>
                  ...
                  <Image className='topImage' alt='top-image' width={1200} height={495} src='/images/fnelkamira-top.png' />
                    ...
                    <Image height={480} width={480} alt='cam1' src='/images/cam2.png' /> 
                        <div className='colom'>
                            ...
                            <FanelCameraItem title='الابتكار واإلبداع' p="  قم بتجربة أفكار جديدة وأنماط موسيقية مبتكرة لجذب انتباه الجمهور وإبراز مهاراتك بشكل مميز." />
                            <FanelCameraItem title='نشر وترويج' p="ادعو أصدقائك وجمهورك للمشاركة والتصويت عىل أدائك." />
                        </div>
