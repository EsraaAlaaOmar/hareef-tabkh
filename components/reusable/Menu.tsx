      ...
      <span className='close'><IoIosCloseCircleOutline  onClick={()=>setshowList()}/></span>
        <ul className="list-unstyled">
            ...
            <li><a href="/http://elchef.info/" className="active">
             ...
             <li><a href="/http://elchef.info/index?state=signin" className="na"><i className="fas fa-heart"></i> <span> المفضلة </span></a></li>
             ...
             <li><a href="/http://elchef.info/categories" className="na"><i className="fas fa-concierge-bell"></i> <span> التصنيفات </span></a></li>
             <li><a href="/http://elchef.info/mostviewed" className="na"><i className="fas fa-fire"></i> <span> الأكثر مشاهدة </span></a></li>
             <li><a href="/http://elchef.info/latest" className="na"><i className="fas fa-utensils"></i> <span> أحدث الوصفات </span></a></li>
             <li><a href="/http://elchef.info/terms" className="na"><i className="fas fa-question"></i> <span> الشروط و الأحكام </span></a>
             </li><li><a href="/http://elchef.info/signin" className="na"><i className="fas fa-sign-out-alt"></i> <span>تسجيل الخروج</span></a></li> 
